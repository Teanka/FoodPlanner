...
-- Schema scrumlab
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `scrumlabspring` DEFAULT CHARACTER SET utf8 ;
USE `scrumlabspring` ;

-- -----------------------------------------------------
-- Table `scrumlab`.`admins`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scrumlabspring`.`admins` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scrumlabspring`.`recipe` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli.',
...
-- Table `scrumlab`.`plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scrumlabspring`.`plan` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli',
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scrumlabspring`.`day_name` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scrumlabspring`.`recipe_plan` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli.',
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scrumlabspring`.`pages` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli',
